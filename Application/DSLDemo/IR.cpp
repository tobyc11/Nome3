...
void IRUnaryOp::Accept(IRVisitor& v) { v.Visit(this); }
void IRBinaryOp::Accept(IRVisitor& v) { v.Visit(this); }
void IRAdd::Accept(IRVisitor& v) { v.Visit(this); }
void IRSub::Accept(IRVisitor& v) { v.Visit(this); }
void IRMul::Accept(IRVisitor& v) { v.Visit(this); }
void IRDiv::Accept(IRVisitor& v) { v.Visit(this); }
void IRDotProduct::Accept(IRVisitor& v) { v.Visit(this); }
void IRCrossProduct::Accept(IRVisitor& v) { v.Visit(this); }
void IRConstructMat3::Accept(IRVisitor& v) { v.Visit(this); }

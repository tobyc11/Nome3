...
QRectF CConnector::boundingRect() const { return QRectF(-40, -40, 40, 40); }
...
void CConnector::paint(QPainter* painter, const QStyleOptionGraphicsItem* option, QWidget* widget)
{
    ...
    static const QPoint points_l[] = { QPoint(-15, 0), QPoint(-7, 10), QPoint(10, 10),
                                       QPoint(10, -10), QPoint(-7, -10) };
    static const QPoint points_r[] = { QPoint(15, 0), QPoint(7, 10), QPoint(-10, 10),
                                       QPoint(-10, -10), QPoint(7, -10) };

...
CDebugDraw::CDebugDraw(Qt3DCore::QNode* parent) : Qt3DCore::QNode(parent)
{
...
void CDebugDraw::LineSegment(tc::Vector3 from, tc::Color fromColor, tc::Vector3 to, tc::Color toColor)
{
    //VVVCCCx2/VVVCCCx2

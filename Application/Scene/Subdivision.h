// Project AddOffset . COmmented out most things. add back asap
...
Sdc::SchemeType SubdivisionType() { return Sdc::SCHEME_CATMARK; }
...
//            {
//                //sharpness[v_itr.idx()] = _m.data(v_itr).sharpness(); Randy commented this out
...
//            {
//                // creases[edge.idx()] = _m.data(edge).sharpness(); Randy commented this out
...
//}
// Project AddOffset - name conflict with DSMesh's Vertex
struct VertexRENAMELATER
{

    // Minimal required interface ----------------------
    VertexRENAMELATER() { }

    VertexRENAMELATER(VertexRENAMELATER const& src)
    {
    ...
    void AddWithWeight(VertexRENAMELATER const& src, float weight)
    {
...
>>>>>>> subdivision
    ...
    {
        std::cerr << "Error: cannot write mesh to " << "/Users/charleszhang/code/nome/nome/temp.obj"
<< std::endl; return 1;
    }
    return true;
};
...
conv.data(conv.vertex_handle(vertex)).sharpness());
=======
